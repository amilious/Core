...
namespace Amilious.Core.FishNet.Chat {
    ...
    public partial class FishNetChatManager : NetworkBehaviour, IChatNetworkManager {
        ...
        /// <inheritdoc />
        public event IChatNetworkManager.SendPrivateMessageDelegate OnPrivateMessageSent;

        /// <inheritdoc />
        public event IChatNetworkManager.ReceiveGroupMessageDelegate OnReceiveGroupMessage;

        /// <inheritdoc />
        public event IChatNetworkManager.SendGroupMessageDelegate OnGroupMessageSent;

        /// <inheritdoc />
        public event IChatNetworkManager.ReceiveServerMessageDelegate OnReceiveServerMessage;
        /// <inheritdoc />
        public event IChatNetworkManager.ReceiveGlobalMessageDelegate OnReceiveGlobalMessage;
        /// <inheritdoc />
        public event IChatNetworkManager.ReceivePrivateMessageDelegate OnReceivePrivateMessage;
