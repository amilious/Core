...
namespace Amilious.Core.FishNet.Users {
    ...
    public partial class FishNetUserIdentityManager {
        ...
        [TargetRpc]
        private void Client_ReceiveFriends(NetworkConnection con, uint[] friendIds) {
            _friends.Clear();
        ...
        [TargetRpc]
        private void Client_ReceivePendingFriends(NetworkConnection con, uint[] pendingFriends) {
        ...
        [TargetRpc]
        private void Client_ReceiveRequestingFriends(NetworkConnection con, uint[] requestingFriends) {
        ...
        [TargetRpc]
        private void Client_ReceiveBlockedUsers(NetworkConnection con, uint[] blockedIds) {
            _blocked.Clear();
        ...
        [TargetRpc]
        private void Client_ReceiveBlockUpdate(NetworkConnection con, uint userId, bool isBlocked) {
        ...
        [TargetRpc]
        private void Client_ReceiveFriendUpdate(NetworkConnection con, uint userId, bool isFriend) {
        ...
        [TargetRpc]
        private void Client_ReceivePendingUpdate(NetworkConnection con, uint userId, bool isPending) {
        ...
        [TargetRpc]
        private void Client_ReceiveRequestingUpdate(NetworkConnection con, uint userId, bool isRequesting) {
