...
namespace Amilious.Core.Saving {
    ...
    public static class IdentitySave {
        ...
        /// </summary>
        #if UNITY_EDITOR
        [MenuItem("Amilious/Core/Identity Save/Reload Data",priority = 0)]
        #endif
        ...
        #if UNITY_EDITOR
        [MenuItem("Amilious/Core/Identity Save/Reset Data", priority = 2)]
        public static void Reset() {
            var sure = EditorUtility.DisplayDialog("Reset Identity Save Data",
        ...
        /// </summary>
        #if UNITY_EDITOR
        [MenuItem("Amilious/Core/Identity Save/Force Save",priority = 1)]
        #endif
