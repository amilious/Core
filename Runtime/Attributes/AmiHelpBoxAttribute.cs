...
namespace Amilious.Core.Attributes {
    ...
    public class AmiHelpBoxAttribute : AmiModifierAttribute {
        ...
        public AmiHelpBoxAttribute(string message, HelpBoxType helpBoxType = HelpBoxType.None) {
            Message = message;
        ...
        /// <param name="helpBoxType">The type of message for the help box.</param>
        public AmiHelpBoxAttribute(string message, string conditionalPropertyName, 
        ...
        /// the helpbox will be shown when the condition is true.</param>
        /// <param name="helpBoxType">The type of message for the help box.</param>
        public AmiHelpBoxAttribute(string message, string conditionalPropertyName, object conditionValue, 
            bool hideIfCondition = false, HelpBoxType helpBoxType = HelpBoxType.None){
            Message = message;
            HelpBoxType = helpBoxType;
            ConditionalPropertyName = conditionalPropertyName;
        ...
        /// </summary>
        /// <param name="serializedProperty">The property that determines if the helpbox should be displayed.</param>
        /// <returns>True if the helpbox should be shown, otherwise false.</returns>
