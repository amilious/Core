...
namespace Amilious.Core.Physics {
    ...
    public class BufferedCaster {
        ...
        public void DoRaycast(Ray ray, float maxDistance = float.PositiveInfinity, int layerMask = -5, 
            QueryTriggerInteraction queryTriggerInteraction = QueryTriggerInteraction.UseGlobal) {
            HitSize = UnityEngine.Physics.RaycastNonAlloc(ray, RaycastBuffer, maxDistance, layerMask, queryTriggerInteraction);
        }
        ...
        public void DoRaycast(Vector3 origin, Vector3 direction, float maxDistance = float.PositiveInfinity, 
            ...
            HitSize = UnityEngine.Physics.RaycastNonAlloc(origin, direction, RaycastBuffer, maxDistance, layerMask, queryTriggerInteraction);
        }
        ...
        public void DoSphereCast(Vector3 origin, in float radius, Vector3 direction,
            float maxDistance = float.PositiveInfinity, int layerMask = -5, 
            QueryTriggerInteraction queryTriggerInteraction = QueryTriggerInteraction.UseGlobal) {
            HitSize = UnityEngine.Physics.SphereCastNonAlloc(origin, radius, direction, RaycastBuffer, maxDistance, layerMask, 
        ...
        public void DoSphereCast(Ray ray, in float radius, float maxDistance = float.PositiveInfinity, 
            int layerMask = -5, QueryTriggerInteraction queryTriggerInteraction = QueryTriggerInteraction.UseGlobal) {
            HitSize = UnityEngine.Physics.SphereCastNonAlloc(ray, radius, RaycastBuffer, maxDistance, layerMask,queryTriggerInteraction);
        }
        ...
        public void DoBoxCast(Vector3 center, Vector3 halfExtents, Vector3 direction,
            float maxDistance = float.PositiveInfinity, int layerMask = -5, 
            QueryTriggerInteraction queryTriggerInteraction = QueryTriggerInteraction.UseGlobal) {
            HitSize = UnityEngine.Physics.BoxCastNonAlloc(center, halfExtents, direction, RaycastBuffer, Quaternion.identity, maxDistance,
        ...
        public void DoBoxCast(Vector3 center, Vector3 halfExtents, Vector3 direction,Quaternion orientation, 
            float maxDistance = float.PositiveInfinity,int layerMask = -5, 
            QueryTriggerInteraction queryTriggerInteraction = QueryTriggerInteraction.UseGlobal) {
            HitSize = UnityEngine.Physics.BoxCastNonAlloc(center, halfExtents, direction, RaycastBuffer, orientation, 
        ...
        public void DoCapsuleCast(Vector3 point1, Vector3 point2, float radius, Vector3 direction, 
            float maxDistance = float.PositiveInfinity, int layerMask = -5, 
            QueryTriggerInteraction queryTriggerInteraction = QueryTriggerInteraction.UseGlobal) {
            HitSize = UnityEngine.Physics.CapsuleCastNonAlloc(point1, point2, radius, direction, RaycastBuffer, maxDistance, layerMask,
                queryTriggerInteraction);
        }
