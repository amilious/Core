...
namespace Amilious.Core.Editor.Extensions {
    ...
    public static class SerializedPropertyExtensions {
        ...
        /// <summary>
        /// This method is used to get an attribute for the given property.
        /// </summary>
        /// <param name="property">The property that you want to get an attribute for.</param>
        /// <param name="inherit">If inherited attributes should be used.</param>
        /// <typeparam name="T">The type of attribute that you want to get.</typeparam>
        ...
        public static T GetAttribute<T>(this SerializedProperty property, bool inherit = true) where T : Attribute{
            ...
            return memberInfo==null ? null : memberInfo.GetCustomAttribute<T>(inherit);
        }

        /// <summary>
        /// This method is used to get the member info for the given property.
        /// </summary>
        /// <param name="property">The property that you want to get the member info for.</param>
        /// <returns>The member info of the given property.</returns>
        ...
        /// <summary>
        /// This method is used to get a unique string to represent the property.
        /// </summary>
        /// <param name="property">The property.</param>
        /// <returns>A unique string for the gameObject and the property.</returns>
        public static string GetUniqueString(this SerializedProperty property) {
            var objId = property.serializedObject.targetObject.GetInstanceID();
            return $"{objId}:{property.propertyPath}";
        }
