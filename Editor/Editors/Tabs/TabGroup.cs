...
namespace Amilious.Core.Editor.Editors.Tabs {
    ...
    public class TabGroup {
        ...
        /// <returns>True if the property was added, otherwise false.</returns>
        public bool TryAddProperty(AmiTabAttribute attribute, AmiButtonAttribute buttonAttribute) {
            var tabInfo = new TabProperty(attribute, buttonAttribute);
            return TryAddProperty(tabInfo);
        }
        ...
        /// <param name="order">The properties order.</param>
        /// <returns>True if the property was added, otherwise false.</returns>
        public bool TryAddProperty(string tabName, AmiButtonAttribute buttonAttribute, int order = 0) {
            var tabInfo = new TabProperty(Name, tabName, buttonAttribute, order);
            return TryAddProperty(tabInfo);
        }
